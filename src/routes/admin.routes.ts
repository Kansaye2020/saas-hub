...
export const ALL_PROVIDERS = [
  {
    ...
    publicKeyLabel: "Clé Publique (X-Public-Key)",
    publicKeyPlaceholder: "Ex: lomo_pub_...",
    secretKeyLabel: "Clé Secrète (X-Secret-Key)",
    secretKeyPlaceholder: "Ex: lomo_sec_...",
  ...
  },
  {
    ...
    publicKeyLabel: "Company ID",
    publicKeyPlaceholder: "Ex: biz_...",
    secretKeyLabel: "API Key (Bearer Token)",
    secretKeyPlaceholder: "Ex: whop_api_...",
    hasExtraConfig: false,
    extraConfigLabel: "",
  },
  {
